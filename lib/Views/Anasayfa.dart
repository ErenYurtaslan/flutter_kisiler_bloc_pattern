...
import 'package:flutter_kisiler_bloc_pattern/Views/Detay.dart';
import 'package:flutter_kisiler_bloc_pattern/Views/KisiKayitSayfasi.dart';
import 'package:flutter_kisiler_bloc_pattern/cubit/AnasayfaCubit.dart';
                          ...
                          child: Row(
                            children: [
                              Padding(
                                ...
                                child: Text("${kisi.kisi_ad} - ${kisi.kisi_no}"),
                              ),
                              const Spacer(),
                              IconButton(onPressed: (){
